...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Map.size'
        db.alter_column(u'maps_map', 'size_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['maps.MapSize']))

    def backwards(self, orm):

        # Changing field 'Map.size'
        db.alter_column(u'maps_map', 'size_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.MapSize'], null=True))
