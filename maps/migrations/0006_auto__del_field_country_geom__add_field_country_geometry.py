...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Country.geom'
        db.delete_column(u'maps_country', 'geom')

        # Adding field 'Country.geometry'
        db.add_column(u'maps_country', 'geometry',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Country.geom'
        db.add_column(u'maps_country', 'geom',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Country.geometry'
        db.delete_column(u'maps_country', 'geometry')
