...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollinsMap.name'
        db.add_column(u'maps_collinsmap', 'name',
                      self.gf('django.db.models.fields.CharField')(default='no name', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollinsMap.name'
        db.delete_column(u'maps_collinsmap', 'name')
