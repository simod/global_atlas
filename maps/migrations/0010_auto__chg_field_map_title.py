...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'maps_map', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Map.title'
        db.alter_column(u'maps_map', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))
