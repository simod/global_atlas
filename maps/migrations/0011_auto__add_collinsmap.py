...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollinsMap'
        db.create_table(u'maps_collinsmap', (
        ...
        db.send_create_signal(u'maps', ['CollinsMap'])


    def backwards(self, orm):
        # Deleting model 'CollinsMap'
        db.delete_table(u'maps_collinsmap')
