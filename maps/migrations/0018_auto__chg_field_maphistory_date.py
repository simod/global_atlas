...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MapHistory.date'
        db.alter_column(u'maps_maphistory', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'MapHistory.date'
        db.alter_column(u'maps_maphistory', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
