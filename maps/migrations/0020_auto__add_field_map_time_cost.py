...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.time_cost'
        db.add_column(u'maps_map', 'time_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=4.0, max_digits=5, decimal_places=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.time_cost'
        db.delete_column(u'maps_map', 'time_cost')
    ...
    models = {
        ...
        u'maps.map': {
            ...
            'advertized': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'time_cost': ('django.db.models.fields.DecimalField', [], {'default': '4.0', 'max_digits': '5', 'decimal_places': '1'}),
