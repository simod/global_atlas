...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MapRequest.quantity'
        db.alter_column(u'maps_maprequest', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'MapRequest.quantity'
        db.alter_column(u'maps_maprequest', 'quantity', self.gf('django.db.models.fields.IntegerField')())
